export function Partners() {
    return (
        <section className="relative py-24 bg-gradient-to-b from-[#0a0f1a] to-[#0d1424]" aria-labelledby="partners-heading">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="relative p-8 md:p-12 rounded-3xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/10 hover:border-cyan-500/30 transition-all duration-500 group">
                        {/* Glow effect */}
                                ...
                                <div className="p-6 rounded-2xl bg-white/[0.03] border border-white/5">
                                    ...
                                    <div className="space-y-4 text-sm">
                                        <div className="flex items-center gap-3 p-3 rounded-lg bg-white/[0.02]">
                                            ...
                                            <span className="text-gray-300">Lives in your Azure tenant</span>
                                        </div>
                                        <div className="flex items-center gap-3 p-3 rounded-lg bg-white/[0.02]">
                                            <svg className="w-5 h-5 text-cyan-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span className="text-gray-300">Uses existing Entra ID permissions</span>
                                        </div>
                                        <div className="flex items-center gap-3 p-3 rounded-lg bg-white/[0.02]">
                                            <svg className="w-5 h-5 text-cyan-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span className="text-gray-300">Takes action in Salesforce, Jira, M365</span>
                                        </div>
                                        <div className="flex items-center gap-3 p-3 rounded-lg bg-white/[0.02]">
                                            <svg className="w-5 h-5 text-cyan-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                            </svg>
                                            <span className="text-gray-300">No data leaves your environment</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
